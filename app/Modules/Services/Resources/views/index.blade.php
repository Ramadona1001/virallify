            ...
            <div class="card">
                <div class="card-header bg-white d-flex align-items-center justify-content-between border-bottom">
                    ...
                    <div style="text-align: end" class="add_btn">
                        <a id="" class="btn btn-primary" href="javascript:void(0);" data-toggle="modal" data-target="#servicesModal">
                                        ...
                                        <tr  class="row_{{$service->id}}">
                                            ...
                                            <td>
                                                @if ($service->image != null)
                                                    <img src="{{ asset($service->image) }}" style="width:40px;">
                                                @else
                                                    {{ transWord('No Image') }}
                                                @endif
                                            </td>
                                            ...
                                            <td>
                                                <ul style="max-width: 50px" class="dtr-details" >
                                                    <li>
                                                        <a href="{{route('edit_services',['service' => $service])}}"
                                                           class="text-info"
                                                           title="Edit"
                                                    ...
                                                    <li>
                                                        <a onclick="return confirm('{{ transWord('Are You Sure?') }}')"  href="{{route('delete_services',['service' => $service] )}}" class="text-danger sa-delete"  title="Delete" data-original-title="Delete">
        ...
        <div class="modal-dialog modal-dialog-scrollable modal-lg">
            <div class="modal-content ">
                <div class="modal-header">
                    <h5 class="modal-title mt-0" id="exampleModalScrollableTitle">{{ transWord('New Service') }}</h5>
