        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header bg-white d-flex align-items-center justify-content-between border-bottom">
                    <strong class="card-title">{{transWord('Social Media ')}}</strong>
                     @can('create_homepage_social_media')
                                ...
                                <table id="example" class="table table-bordered dt-responsive nowrap"
                                    ...
                                    @foreach($media_items as $index => $media)
                                        <tr  class="unitRow_{{$media->id}}">
                                            ...
                                            <td>
                                                <a class="text-info" href="{{$media->social_link}}">Visit link</a>
                                            </td>


                                            <td>
                                                <ul style="max-width: 50px" class="dtr-details mx-1" >
                                                    @can('update_homepage_social_media')
                                                    <li>
                                                        <a href="{{route('edit_social_media',['media' => $media])}}"
                                                    ...
                                                    @can('delete_homepage_social_media')
                                                    <li>
                                                        <a onclick="return confirm('{{ transWord('Are You Sure?') }}')"  href="{{route('delete_social_media',['media' => $media] )}}" class="btn btn-sm btn-danger sa-delete"  title="Delete" data-original-title="Delete">
        ...
        <div class="modal-dialog modal-dialog-scrollable modal-lg">
            <div class="modal-content ">
                <div class="modal-header">
                    <h5 class="modal-title mt-0" id="exampleModalScrollableTitle">New Social Media</h5>
                ...
                <div class="modal-body p-3">
                    <form action="{{route('store_social_media')}}" method="post" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group row">
                                    <label for="social_link" class="">{{transWord('Social Link')}}</label>
                                    <div class="mt-4 mt-lg-0">
                                        <input type="url" id="social_link" class="form-control" name="social_link" required>
                                    </div>
                                </div>
                            </div>
